-- Fix: Allow calendar to fetch past availability so admin can view old reservations on the calendar
-- Change the generate_series to start 12 months in the past and extend 12 months in the future
