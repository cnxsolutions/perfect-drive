-- Fix: Restore time-based partial availability logic for DateAvailability
-- Specifically fixing the is_fully_blocked error introduced in multi_vehicles_stock_v2
